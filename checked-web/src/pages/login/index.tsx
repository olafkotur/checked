...
import { Button, Typography, TextField, Grid, Link, Card, CardContent, Snackbar, FormControlLabel, Checkbox, IconButton, Tooltip } from '@material-ui/core';
...
export class Login extends React.Component<IProps, IState> {
    ...
    handleSignIn(email: string, password: string): void {
        ...
        if(this.props.isMemberLogin){
            setTimeout(() => {
                MemberService.login(email, password).then((res) => {
                    if (res.status === 'ok') {
                        this.props.setAuthorised(true);
                        this.props.setMember(true);
                        this.props.setUserID(res.result.memberId);
                    } else {
                ...
                <div className="tiledBackground vcenterParent overflow-hidden">
                    <Card className="col-md-4 offset-md-4 col-sm-8 offset-sm-2 col-10 offset-1 pr-5 pl-5 vcenterChild signInCard signInCardOnScreen">
                        <CardContent>
                            ...
                            <div className="text-center w-100 mt-3" style={{zIndex: 99}}>
                            ...
                            <div className="loaderDiv text-center mt-1 vcenterParent" style={{ zIndex: 9 }}>
            ...
            return (
                <div className="tiledBackground vcenterParent overflow-hidden">
                    <Card className="col-md-4 offset-md-4 col-sm-8 offset-sm-2 col-10 offset-1 pr-5 pl-5 vcenterChild signInCard signInCardOnScreen">
                        <CardContent>
                            <div className="col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-12 text-center">
                                <img src={Logo} className="logo mb-4 mt-2" alt="logo" />
                            </div>
                            <div className="text-center w-100">
                                <Typography variant="h6" className="montserrat">
                                    Checked
