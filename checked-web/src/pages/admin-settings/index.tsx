...
import AdminSettingsContent from '../../components/AdminSettings';
...
export class AdminSettings extends React.Component<IProps, IState> {
                        ...
                        <Card className="dashCard mr-5">
                            ...
                            {this.state.loaded && 
                                <Grid container spacing={0} >
                                    <Grid item xs={12}>
                                        <CardHeader title="Settings" avatar={<Person className="w-100 h-100" fontSize="large"/>} className="mutedBlack mt-2">
                                        </CardHeader>
                                    </Grid>
                                    <Grid item xs={12}>
                                        <CardContent className="pt-1 ml-3 mr-3 pl-0 pr-0 border-top border-muted">
                                            <AdminSettingsContent userID={this.props.userID} members={this.state.members} />
                                        </CardContent>
                                    </Grid>
                                </Grid>
                            }   
